...
class OkraFetchPageShortBuild extends StatefulWidget {
  //OkraFetchPageShortBuild({Key? key, required this.title, required this.amount}) : super(key: key);
  //OkraFetchPageShortBuild({Key? key, required this.title}) : super(key: key);
  const OkraFetchPageShortBuild({Key? key}) : super(key: key);
  ...
  @override
  _OkraFetchPageShortBuildState createState() => _OkraFetchPageShortBuildState();
}

class _OkraFetchPageShortBuildState extends State<OkraFetchPageShortBuild> {
