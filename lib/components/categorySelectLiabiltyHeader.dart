...
class CategorySelectLiabiltyHeader extends StatelessWidget {
  const CategorySelectLiabiltyHeader({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      //update to add/remove spacing between switchable tabs
