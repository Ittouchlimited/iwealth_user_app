    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return FilesOneUploadMania(index: index);
        },
      ),
    );
  }
...
class FilesOneUploadMania extends StatefulWidget {
  final int index;

  const FilesOneUploadMania({Key? key, required this.index}) : super(key: key);

  @override
  _FilesOneUploadManiaState createState() => _FilesOneUploadManiaState();
}

class _FilesOneUploadManiaState extends State<FilesOneUploadMania> {
  late File _file;
