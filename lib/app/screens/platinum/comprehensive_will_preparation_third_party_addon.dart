...
class ComprehensiveWillPreparationThirdPartyAddOnScreen extends StatelessWidget {
  const ComprehensiveWillPreparationThirdPartyAddOnScreen({Key? key}) : super(key: key);
...
class _AddonTwoUploadManiaState extends State<AddonTwoUploadMania> {
  ...
  Future<void> _sendNotification() async {
    ...
    final notificationData = {
      'title': userId + ' Requested for 3rd Party Comprehensive Will preparation service.',
      'sendfile': _fileName,
    };
