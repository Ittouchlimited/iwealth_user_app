...
class PlatinumFilesOneScreen extends StatelessWidget {
  const PlatinumFilesOneScreen({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return PlatinumFilesOneUploadMania(index: index);
        },
      ),
    );
  }
...
class PlatinumFilesOneUploadMania extends StatefulWidget {
  final int index;

  const PlatinumFilesOneUploadMania({Key? key, required this.index})
      : super(key: key);

  @override
  _PlatinumFilesOneUploadManiaState createState() =>
      _PlatinumFilesOneUploadManiaState();
}

class _PlatinumFilesOneUploadManiaState
    extends State<PlatinumFilesOneUploadMania> {
  late File _file;
  ...
  Future<void> _sendNotification() async {
    ...
    final notificationData = {
      'title': userId + ' Requested for Platinum file 01',
      'sendfile': _fileName,
    };
