...
import 'package:pinext/pages/dog_form_page_platinum.dart';
...
class FlutterwaveTwo extends StatefulWidget {

  FlutterwaveTwo(this.title);

  final String title;


  @override
  _FlutterwaveTwoState createState() => _FlutterwaveTwoState();
}

class _FlutterwaveTwoState extends State<FlutterwaveTwo> {
  ...
  String amount = flutterwavePlatinumPlanSubFee;
  ...
  void initState() {
    super.initState();
    _inputControllerRegular.text = "Before you make payment";
          ...
          child: ListView(
            children: <Widget>[
              ...
              */
              ...
              const Text("* Track & update assets & Liabilities \n"
              ...
              Container(
                ...
                child:
                //Subscription verification start
                const Text("Ensure you have deleted your current subscription",
                  style: TextStyle(
                    fontSize: 13,
                  ),
  ...
  _handlePaymentInitialization() async {
    ...
    if (response != null) {
      ...
      Navigator.of(context)
          .push(
          MaterialPageRoute(builder: (context) => const DogFormPagePlatinum()));
