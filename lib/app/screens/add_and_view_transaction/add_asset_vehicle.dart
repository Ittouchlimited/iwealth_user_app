...
class AddAssetVehicleScreen extends StatelessWidget {
  AddAssetVehicleScreen({
    Key? key,
...
class AddAssetVehicleView extends StatefulWidget {
  AddAssetVehicleView({
    Key? key,
  ...
  @override
  State<AddAssetVehicleView> createState() =>
      _AddAssetVehicleViewState();
}

class _AddAssetVehicleViewState extends State<AddAssetVehicleView> {
  ...
  void initState() {
    ...
    detailsController.text = "Vehicle Asset";
...
//Copy this
  ...
  save(BuildContext context) {
    transDetailController!.titleField.text = "Vehicle";
