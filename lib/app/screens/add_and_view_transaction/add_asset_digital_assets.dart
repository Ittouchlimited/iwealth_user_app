...
class AddAssetDigitalAssetsScreen extends StatelessWidget {
  AddAssetDigitalAssetsScreen({
    Key? key,
...
class AddAssetDigitalAssetsView extends StatefulWidget {
  AddAssetDigitalAssetsView({
    Key? key,
  ...
  @override
  State<AddAssetDigitalAssetsView> createState() =>
      _AddAssetDigitalAssetsViewState();
}

class _AddAssetDigitalAssetsViewState extends State<AddAssetDigitalAssetsView> {
  ...
  void initState() {
    ...
    detailsController.text = "Digital Assets";
...
//Copy this
  ...
  save(BuildContext context) {
    transDetailController!.titleField.text = "Digital Assets";
    //transDetailController!.amountField.text = "";
    //transDetailController!.amountField.text = amountController.text;


    //Update this
    transDetailController!.selectedDepartment == digitalassets;
    transDetailController!.changeDepartment(digitalassets);
    //Update this
