...
class ProfileCompletenessPage extends StatefulWidget {
  ProfileCompletenessPage({
    Key? key,
  ...
  @override
  State<ProfileCompletenessPage> createState() =>
      _ProfileCompletenessPageState();
}
...
class _ProfileCompletenessPageState extends State<ProfileCompletenessPage> {
  double netBalance = 0;
  String? _fileName;
  File? _uploadedFile;
  final _formKey = GlobalKey<FormState>();
