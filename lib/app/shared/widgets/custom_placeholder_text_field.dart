...
class CustomPlaceyholderTextFormField extends StatefulWidget {
  ...
  CustomPlaceyholderTextFormField(
      {Key? key,
      required this.controller,
      required this.hintTitle, required this.placeHolderText,
  ...
  @override
  State<CustomPlaceyholderTextFormField> createState() => _CustomPlaceyholderTextFormFieldState();
}

class _CustomPlaceyholderTextFormFieldState extends State<CustomPlaceyholderTextFormField> {
  @override
  void initState() {
