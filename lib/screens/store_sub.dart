...
import 'package:pinext/helpers/manage_subscription.dart';
...
//In App Product Ids
//const String coins_10Id = 'silver';
//const String coins_20Id = 'platinum';
...
//Subscription Ids
//const String yearlySubscriptionId = 'silver';
const String yearlySubscriptionId = 'regular';
//const String yearlySubscriptionTwoId = 'platinum';
...
class _StoreState extends State<Store> {
      ...
      body: SafeArea(
        child: Container(
          ...
          child: Column(children: [
            ...
            const Text(
              "By subscribing you get access to more features from Norrenberger.",
              textAlign: TextAlign.center,
            ),
          ]),
        ),
  ...
  Future<void> _deliverProduct(PurchaseDetails purchaseDetails) async {
    ...
    } /*else if (purchaseDetails.productID == yearlySubscriptionTwoId) {
      ManageSubscription.updateWeeklySub(purchaseDetails);
    }*/
    setState(() {
      _purchasePending = false;
  ...
  void checkSubscription(List<PurchaseDetails> purchaseDetailsList) {
    if (purchaseDetailsList.isNotEmpty) {
      for (int i = 0; i < purchaseDetailsList.length; i++) {
        ...
        } else */if (purchaseDetailsList[i].productID == yearlySubscriptionId) {
          ManageSubscription.updateMonthlySub(purchaseDetailsList[i]);
        } /*else if (purchaseDetailsList[i].productID == yearlySubscriptionTwoId) {
          ManageSubscription.updateMonthlySub(purchaseDetailsList[i]);
        }*/
      }
    } else {
