...
import 'package:pinext/app/screens/add_and_view_transaction/add_asset_custom_asset.dart';
...
class AddAssetCustomAssetView extends StatelessWidget {
  final String image;
  final String text1;
  final String text2;
  final String text3;
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => AddAssetCustomAssetScreen()),
        );
      },
      child: Container(
        height: 80,
