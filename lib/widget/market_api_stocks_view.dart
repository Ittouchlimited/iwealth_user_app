...
class MarketApiStocksView extends StatelessWidget {
  final String image;
  final String text1;
  final String text2;
  final String text3;
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(builder: (context) => const LifeCheckerView(title: 'Flutter Local Notifications')),
