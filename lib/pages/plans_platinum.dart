...
import 'package:pinext/app/screens/subscriptions/flutterwave_02.dart';
import 'package:pinext/common_widgets/dog_builder.dart';
import 'package:pinext/common_widgets/breed_builder.dart';
import 'package:pinext/common_widgets/plan_builder_platinum.dart';
...
class PlansPlatinum extends StatefulWidget {
  const PlansPlatinum({Key? key}) : super(key: key);

  @override
  _PlansPlatinumState createState() => _PlansPlatinumState();
}

class _PlansPlatinumState extends State<PlansPlatinum> {
        ...
        appBar: AppBar(
          ...
          bottom: TabBar(
            tabs: [
              ...
              Padding(
                padding: const EdgeInsets.symmetric(vertical: 16.0),
                child: Text('Available PlansPlatinum'),
              ),
          ...
          children: [
            ...
            FloatingActionButton(
              ...
              onPressed: () {
                ...
                Navigator.of(context)
                    .push(
                  MaterialPageRoute(builder: (context) => FlutterwaveTwo("Subscribe")
