...
class DogFormPagePlatinum extends StatefulWidget {
  const DogFormPagePlatinum({Key? key, this.dog}) : super(key: key);
  final Dog? dog;

  @override
  _DogFormPagePlatinumState createState() => _DogFormPagePlatinumState();
}

class _DogFormPagePlatinumState extends State<DogFormPagePlatinum> {
  ...
  Future<void> _onSave() async {
    //final name = _nameController.text = "Platinum";
